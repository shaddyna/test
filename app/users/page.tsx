...
import { useEffect, useState } from 'react';
import Link from 'next/link';
import { ArrowLeft, Trash2, User, Calendar, Shield, X } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#edf6f4] to-[#cfe0db]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#044536] mt-4">All Users</h1>
          <p className="text-[#4e7c6f] mt-2">
            {currentUserRole === 'admin' 
              ? 'Manage all registered users' 
              : 'View all members of the community'}
          </p>
        </div>
          ...
          {users.map((user) => (
            ...
            >
              <div className="flex items-center justify-between flex-wrap gap-4">
                ...
                {/* Delete button only visible to admins and not for deleting themselves */}
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 relative">
            ...
            <h3 className="text-xl font-bold text-[#044536] mb-3">Confirm Delete User</h3>
            <p className="text-gray-600 mb-6">
              Are you sure you want to delete this user? All their images will also be permanently deleted. This action cannot be undone.
            </p>
